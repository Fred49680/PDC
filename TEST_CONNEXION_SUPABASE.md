...
Vérifier que votre configuration Supabase fonctionne correctement.

---

## 📝 FICHIER DE TEST

Créez ce fichier pour tester la connexion :
...
1. **Créer le fichier** : `src/app/test-supabase/page.tsx`
2. **Démarrer le serveur** : `npm run dev`
3. **Accéder à** : `http://localhost:3000/test-supabase`

---

## ✅ RÉSULTATS ATTENDUS

### Si le schéma SQL n'est pas encore exécuté :
```
✅ Connexion Supabase OK (table "sites" pas encore créée)
```

### Si le schéma SQL est exécuté :
```
✅ Connexion Supabase réussie !
Détails: X site(s) trouvé(s)
```

### Si erreur de configuration :
```
❌ Erreur de connexion
Détails: [code d'erreur et message]
```

---

**Utilisez cette page pour vérifier votre configuration !** 🧪

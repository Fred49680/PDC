...
SELECT 
    ...
    'CP',
    'IES',
    'Saisi par Laïd - en attente de validation admin',
    'Non',
    NOW()::timestamp,
    'Actif'
FROM ressources r
...
SELECT 
    ...
    'VM',
    NULL,
    'Validé par arnaud.gallet le 11/12/2025 11:47',
    'Oui',
...
SELECT 
    ...
    'FORMATION',
    'IEG',
    'Recyclage Culture Sûreté - De 10H à 12H - CNPE Blayais',
    'Non',
...
SELECT 
    ...
    'FORMATION',
    'IEG',
    'CHEVILLAGE - Validé par mathieu.hecht le 22/12/2025 07:14',
    'Oui',
    NOW()::timestamp,
    'Actif'
FROM ressources r
...
SELECT 
    ...
    'CP',
    'IEG',
    'Validé par mathieu.hecht le 22/12/2025 10:39',
    'Oui',
...
SELECT 
    ...
    'CP',
    'IEG',
    'Validé par antoine.tournier le 22/12/2025 15:22',
    'Oui',
...
SELECT 
    ...
    'CP',
    'ENCADREMENT',
    'Validé par fabienne.bongiovanni le 23/12/2025 10:06',
    'Oui',
...
SELECT 
    ...
    'VM',
    NULL,
    'Validé par fabienne.bongiovanni le 23/12/2025 10:10',
    'Oui',
